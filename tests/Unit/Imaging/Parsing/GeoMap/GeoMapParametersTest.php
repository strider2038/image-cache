...
class GeoMapParametersTest extends TestCase
{
    ...
    public function geoMapParametersProvider(): array
    {
        return [
            ...
            ['terrain', 0, 0, 1, 50, 50, 1, 0],
            ['invalid', 0, 0, 1, 50, 50, 1, 1],
            ['roadmap', -90, 0, 1, 50, 50, 1, 0],
            ['roadmap', -90.1, 0, 1, 50, 50, 1, 1],
            ['roadmap', 90, 0, 1, 50, 50, 1, 0],
            ['roadmap', 90.1, 0, 1, 50, 50, 1, 1],
            ['roadmap', 0, -180, 1, 50, 50, 1, 0],
            ['roadmap', 0, -180.1, 1, 50, 50, 1, 1],
            ['roadmap', 0, 180, 1, 50, 50, 1, 0],
            ['roadmap', 0, 180.1, 1, 50, 50, 1, 1],
            ['roadmap', 0, 0, 1, 50, 50, 1, 0],
            ['roadmap', 0, 0, 0, 50, 50, 1, 1],
            ['roadmap', 0, 0, 20, 50, 50, 1, 0],
            ['roadmap', 0, 0, 21, 50, 50, 1, 1],
            ['roadmap', 0, 0, 1, 50, 50, 1, 0],
            ['roadmap', 0, 0, 1, 49, 50, 1, 1],
            ['roadmap', 0, 0, 1, 640, 50, 1, 0],
            ['roadmap', 0, 0, 1, 641, 50, 1, 1],
            ['roadmap', 0, 0, 1, 50, 50, 1, 0],
            ['roadmap', 0, 0, 1, 50, 49, 1, 1],
            ['roadmap', 0, 0, 1, 50, 640, 1, 0],
            ['roadmap', 0, 0, 1, 50, 641, 1, 1],
            ['roadmap', 0, 0, 1, 50, 50, 1.0, 0],
            ['roadmap', 0, 0, 1, 50, 50, 0.9, 1],
            ['roadmap', 0, 0, 1, 50, 50, 4.0, 0],
            ['roadmap', 0, 0, 1, 50, 50, 4.1, 1],
        ];
    }
}
