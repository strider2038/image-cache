 ...
 */
class ComponentsContainer extends Object {
    ...
    public function get($name) {
        ...
        if ($this->components[$name] instanceof Object) {
            return $this->components[$name];
        }
        if (is_callable($this->components[$name])) {
            $obj = $this->components[$name]();
            if (!$obj instanceof Object) {
                throw new ApplicationException("Component '{$name}' must be instance of Strider2038\ImgCache\Core\Object");
            }
